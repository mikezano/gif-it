...
define('text!resources/elements/gif-embed-dialog.html', ['module'], function(module) { module.exports = "<template><require from=\"./gif-embed-dialog.css\"></require><ux-dialog><h2>Embed Options</h2><ux-dialog-body><p>1. Select Size</p><div class=\"size-group\"><input type=\"radio\" name=\"size-group\" change.delegate=\"updateEmbedCode('Small')\"/><div class=\"image-sizing\"><i class=\"fa fa-picture-o\"></i><p>S</p></div><input type=\"radio\" name=\"size-group\" change.delegate=\"updateEmbedCode('Medium')\"/><div class=\"image-sizing\"><i class=\"fa fa-picture-o fa-2x\"></i><p>M</p></div><input type=\"radio\" name=\"size-group\" change.delegate=\"updateEmbedCode('Large')\"/><div class=\"image-sizing\"><i class=\"fa fa-picture-o fa-3x\"></i><p>L</p></div><input type=\"radio\" name=\"size-group\" change.delegate=\"updateEmbedCode('Custom')\"/><div class=\"image-sizing\">Custom</div></div></ux-dialog-body><ux-dialog-footer><p>footer</p></ux-dialog-footer></ux-dialog><!--ai-dialog#gif-embedh1 Embed Options\n\nai-dialog-body\n\tp.instruction 1. Select Size\n\t.input-field.size-group\n\n\t\t\tinput(type=\"radio\" name=\"size-group\" change.delegate=\"updateEmbedCode('Small')\")\n\t\t\t.image-sizing\n\t\t\t\ti.fa.fa-picture-o\n\t\t\t\tp S\n\t\t\t\n\t\t\tinput(type=\"radio\" name=\"size-group\" change.delegate=\"updateEmbedCode('Medium')\")\n\t\t\t.image-sizing\n\t\t\t\ti.fa.fa-picture-o.fa-2x\n\t\t\t\tp M\n\n\t\t\tinput(type=\"radio\" name=\"size-group\" change.delegate=\"updateEmbedCode('Large')\")\n\t\t\t.image-sizing\n\t\t\t\ti.fa.fa-picture-o.fa-3x\n\t\t\t\tp L\n\n\t\t\tinput(type=\"radio\" name=\"size-group\" change.delegate=\"updateEmbedCode('Custom')\")\n\t\t\t.image-sizing Custom\n\n\n\t.custom(if.bind=\"showCustom\")\n\t\t.input-field\n\t\t\tspan Width\n\t\t\tinput(value.bind=\"width\")\n\t\t\tspan px\n\t\t.input-field\n\t\t\tspan Height\n\t\t\tinput(value.bind=\"height\")\n\t\t\tspan px\n\n\n\tp.instruction 2. Select Category\n\t.input-field\n\t\tselect(value.bind=\"category\")\n\t\t\toption(value=\"All\") All\n\t\t\toption(value=\"Success\") Success\n\t\t\toption(value=\"Fail\") Fail\n\t\t\toption(value=\"Loading\") Loading\n\n\tp.instruction 3. Add this markup where gifs will appear\n\t.input-field\n\t\tpre ${fullEmbedCode}\n\n\tp.instruction 4. Add this to your code to trigger gifs\n\t.input-field\n\t\tpre ${triggerGifCode()}\n\nai-dialog-footer\n\tbutton(click.trigger=\"controller.cancel()\") Cancel\n\tbutton#copy-embed-code OK--></template>"; });
define('text!resources/elements/gif-embed-dialog.css', ['module'], function(module) { module.exports = "ai-dialog-container {\n  overflow: hidden; }\n\n#gif-embed {\n  background-color: linear-gradient(#383838, #525252);\n  background: -webkit-linear-gradient(#383838, #525252);\n  border: 1px solid #525252;\n  color: white; }\n  #gif-embed h1 {\n    padding: 0 10px; }\n  #gif-embed p {\n    margin: 0; }\n    #gif-embed p.instruction:not(:first-child) {\n      margin: 14px 0 4px 0; }\n  #gif-embed .custom {\n    margin: 10px 0; }\n    #gif-embed .custom span {\n      width: 50px;\n      display: inline-block; }\n    #gif-embed .custom input {\n      width: 80px;\n      color: black;\n      border-radius: 3px;\n      border: none; }\n  #gif-embed .input-field select {\n    color: black;\n    border-radius: 3px;\n    background-color: #ebebe4;\n    color: black;\n    margin-bottom: 10px; }\n  #gif-embed .input-field.size-group p {\n    text-align: center; }\n  #gif-embed .input-field input[type=radio] {\n    position: relative;\n    top: -18px;\n    margin-right: 6px; }\n    #gif-embed .input-field input[type=radio]:not(:first-child) {\n      margin-left: 30px; }\n  #gif-embed .input-field .image-sizing {\n    display: inline-block; }\n    #gif-embed .input-field .image-sizing:last-child {\n      position: relative;\n      top: -20px; }\n  #gif-embed .input-field textarea {\n    color: gray;\n    width: 100%;\n    height: 80px;\n    font-family: \"Courier New\"; }\n"; });
